...
for(i in 1:n_check){
  ...
  mean_check[i] <- draw_mean(
      ...
      , sigma.sq_0 = n_check # assume flat prior (the variance is a very large number to be uniformative)
...
for(c in 1:n_chains){
  for(i in 2:n_iterations){
    ...
    posterior_mean[c, i] <- draw_mean(
        mu_0 = 0 # assume flat prior
        , sigma.sq_0 = n_iterations # assume flat prior (the variance is a very large number to be uniformative)
